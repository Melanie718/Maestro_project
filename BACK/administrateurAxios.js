...
function modifierApprenant(pIdAp)
{
    ...
    axios.get(`${url}/apprenant/${pIdAp}`)
        .then(function (response) {
            console.log("AXIOS - modifierApprenant()", response);
        ...
        .catch(function (error) {
            console.log("AXIOS - modifierApprenant()", error);
        });
...
function validerModApprenant(pIdAp)
{
    ...
    axios.put(`${url}/apprenant`, apprenantModifier)
        .then(function (response) {
            console.log("AXIOS validerModApprenant", response);
            document.location.reload();
        })
        .catch(function (error) {
            console.log(error);
...
function montrerEnseignant()
{
    ...
    axios.get(`${url}/enseignant`)
        .then(function (response) {
            console.log("AXIOS - montrerEnseignant()", response);
            response.data.forEach(element =>
            {
        ...
        .catch(function (error)
        {
            console.log("AXIOS - montrerEnseignant()",error);
        });
}
...
{
    console.log("AXIOS creerEnseignant()");
    ...
    let enseignantInputsArray = Array.from(enseignantInputs);
        ...
        if(enseignantInputsArray.every(estRemplis) === true)
        {
            ...
            .then(function (response) {
                console.log("AXIOS creerEnseignant", response);
                document.location.reload();
            })
            .catch(function (error)
            {
...
{
    console.log('AXIOS - supprimerEnseignant()');
    axios.delete(`${url}/enseignant/${pIdEns}`)
    .then(function (response) {
        console.log("AXIOS - supprimerEnseignant() - GG t'as supprimer l'enseignant",pIdEns, response);
        document.location.reload();
    })
    .catch(function (error)
        {
            console.log("AXIOS - supprimerEnseignant()", error);
        });
}
...
function modifierEnseignant(pIdEns)
{
    ...
    axios.get(`${url}/enseignant/${pIdEns}`)
        .then(function (response) {
            console.log("AXIOS - modifierEnseignant()", response);
        ...
        .catch(function (error) {
            console.log("AXIOS - modifierEnseignant()", error);
        });
}
...
function validerModEnseignant(pIdEns)
{
    ...
    axios.put(`${url}/enseignant`, enseignantModifier)
        .then(function (response) {
            console.log("AXIOS validerModAEnseignant", response);
            document.location.reload();
        })
        .catch(function (error) {
            console.log(error);
